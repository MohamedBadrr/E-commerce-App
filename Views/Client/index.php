...
<!-- 					
            ...
            <?php
              ...
              ?>
                ...
                <div class="col-md-4">
                                  <div class="card">
                                      <img class="card-img-top" src="<?php echo $product['image'] ?>" alt="Card image cap" width="250px" height="350px">
                                      <div class="card-body">
										  ...
										  <button type="button" class="btn  btn-info">Product Ditaiels</button>
                                          </a>
                                      </div>
                                  </div>
                              </div>
